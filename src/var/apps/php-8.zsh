...
php-8::install()
{
	...
	apt install -y php8.1 php-sass php-cli php-pear
	apt install -y php8.1-{amqp,cli,common,curl,fpm,gd,gnupg,imagick,imap,intl,mailparse,mbstring,memcached,mongodb,oauth,opcache,pgsql,psr,readline,redis,smbclient,ssh2,sqlite3,uploadprogress,xdebug,xml,yaml,zip}
...
php-8::remove()
{
	...
	apt purge -y php8.1 php-sass
	apt purge -y php8.1-{amqp,cli,common,curl,fpm,gd,gnupg,imagick,imap,intl,mailparse,mbstring,memcached,mongodb,oauth,opcache,pgsql,psr,readline,redis,smbclient,ssh2,sqlite3,uploadprogress,xdebug,xml,yaml,zip}
